...
namespace DCEM.UserCenterService.Main.Application.App
{
    ...
    public class AppBlindOrder : IAppBlindOrder
    {
        
        public IBlindOrderService _blindorderService;
        
        public AppBlindOrder(IBlindOrderService blindorderService)
        {
            _blindorderService=blindorderService;
        }
