...
namespace DCEM.UserCenterService.Main.Factory
{
    ...
    public class UserMsgFactory : IFactory<Task<IAppUserMsg>>
    {
        
        public virtual Task<IAppUserMsg> Create()
        {
            var crmService = StartupHelper.CreateCrmService();
                IUserMsgRepository usermsgrepository = new UserMsgRepository();
                IUserMsgService usermsgservice = new UserMsgService(crmService, usermsgrepository);
                IAppUserMsg app = new AppUserMsg(usermsgservice); 
