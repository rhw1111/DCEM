    ...
    this._http.get(
        ...
        (res: any) => {
          if (res != null) {
            ...
            this.mod.data.Account.mcs_estimatedtransactiondate = res["Attributes"]["mcs_estimatedtransactiondate"];//预测成交日期
            ...
            this.mod.data.Account.mcs_carereason = res["Attributes"]["mcs_carereason"];//关注原因
            ...
            this.mod.data.Account.mcs_contactlevel = res["Attributes"]["mcs_contactlevel"];//客户级别
            ...
            this.mod.data.Account.mcs_gender = res["Attributes"]["mcs_gender"];//称呼
            this.mod.data.Account.mcs_generation = res["Attributes"]["mcs_generation"];//年龄段
            this.mod.data.Account.mcs_idtype = res["Attributes"]["mcs_idtype"];//证件类型
            this.mod.data.Account.mcs_ishavechildren = res["Attributes"]["mcs_ishavechildren"];//是否有子女
            this.mod.data.Account.mcs_ismarry = res["Attributes"]["mcs_ismarry"];//婚姻状态
            this.mod.data.Account.mcs_level = res["Attributes"]["mcs_level"];//意向等级
            this.mod.data.Account.mcs_purchasepurpose = res["Attributes"]["mcs_purchasepurpose"];//购买用途
            this.mod.data.Account.mcs_purchaseway = res["Attributes"]["mcs_purchaseway"];//购买方式
            this.mod.data.Account.mcs_religion = res["Attributes"]["mcs_religion"];//宗教信仰
            this.mod.data.Account.mcs_salesopportunitytype = res["Attributes"]["mcs_salesopportunitytype"];//下发类型
            this.mod.data.Account.mcs_salestype = res["Attributes"]["mcs_salestype"];//销售类型
            this.mod.data.Account.mcs_vehicleusers = res["Attributes"]["mcs_vehicleusers"];//车辆使用人
