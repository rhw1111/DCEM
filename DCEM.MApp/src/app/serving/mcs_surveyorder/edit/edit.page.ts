    ...
    if (data != null && typeof data != undefined) {
        if (data != null && typeof data != undefined) {
            if (data.accountid != null) {
                this.model.postData.mcs_accountname = data.accountnumber;
...
pageOnBind(id: any) {
  ...
  this._http.postForToaken(
    ...
    (res: any) => {
      ...
      this.model.postData.mcs_surveyordertype = res["Attributes"]["mcs_surveyordertype"];
      this.model.postData.mcs_accountid = res["Attributes"]["mcs_accountid"];
      this.model.postData.mcs_accountname = res["Attributes"]["mcs_mallordercode"];
      ...
      this.model.postData.mcs_carmodelid = res["Attributes"]["mcs_carmodelid"];
      this.model.postData.mcs_carmodelname = res["Attributes"]["mcs_carmodelname"];
      this.model.postData.mcs_dealer = res["Attributes"][" mcs_dealer"];
      this.model.postData.mcs_dealername = res["Attributes"]["mcs_dealername"];
      ...
      this.model.postData.mcs_province = res["Attributes"]["mcs_province"];
      this.model.postData.mcs_provincename = res["Attributes"]["mcs_province"];
      this.model.postData.mcs_city = res["Attributes"]["mcs_city"];
      this.model.postData.mcs_cityname = res["Attributes"]["mcs_city"];
      this.model.postData.mcs_area = res["Attributes"]["mcs_area"];
      this.model.postData.mcs_areaname = res["Attributes"]["mcs_area"];
      ...
      this.model.postData.mcs_residentialnature = res["Attributes"]["mcs_residentialnature"];
      this.model.postData.mcs_parkingspace = res["Attributes"]["mcs_parkingspace"];
      this.model.postData. mcs_remark = res["Attributes"][" mcs_remark"];
      this.model.postData.mcs_residentialtype = res["Attributes"]["mcs_residentialtype"];
