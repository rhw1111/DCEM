...
var AppointmentPage = /** @class */ (function () {
    ...
    AppointmentPage.prototype.showDetail = function (item) {
    ...
    AppointmentPage.prototype.enableTemplate = function (startID) {
        this.isTrue = 'true1';
        this.settabcolor(1);
    };
    AppointmentPage.prototype.applicationTemplate = function (suspend) {
        this.isTrue = 'true2';
        this.settabcolor(2);
    };
    AppointmentPage.prototype.recordTemplate = function (record) {
        this.isTrue = 'true3';
        this.settabcolor(3);
    };
    AppointmentPage.prototype.settabcolor = function (id) {
        this.spanColor1 = "";
        this.spanColor2 = "";
        this.spanColor3 = "";
        this.spanColor4 = "";
