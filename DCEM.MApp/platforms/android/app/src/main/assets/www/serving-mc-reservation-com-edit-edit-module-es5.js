...
/* harmony import */ var _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../base/base.ser/optionset.service */ "./src/app/base/base.ser/optionset.service.ts");
...
var EditPage = /** @class */ (function () {
    function EditPage(_modalCtrl, _navCtrl, _http, _page, _logininfo, _shareData, _valid, activeRoute, _optionset) {
    ...
    EditPage.prototype.AppointmentConfigOption = function (ordertype, appointmentat) {
        ...
        this._http.get(this.model.apiConfigUrl, {
            ...
            if (res.Results !== null) {
                ...
                _this._page.alert("消息提示", "预约时段数据加载异常");
            }
        }, function (err) {
            _this._page.alert("消息提示", "预约时段数据加载异常");
        });
    ...
    EditPage.prototype.pageOnBind = function (id) {
        ...
        this._http.getForToaken(this.model.apiUrl, {
            ...
            if (res !== null) {
                _this.model.isAppointmentAtChange = false;
                _this.model.isOrderTypeChange = false;
    ...
    EditPage.ctorParameters = function () { return [
        ...
        { type: _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_9__["OptionSetService"] }
    ]; };
    EditPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
            ...
            _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_9__["OptionSetService"]])
    ], EditPage);
    return EditPage;
}());
