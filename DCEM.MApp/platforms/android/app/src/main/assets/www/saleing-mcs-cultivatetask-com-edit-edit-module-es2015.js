...
let EditPage = class EditPage {
    constructor(_modalCtrl, _navCtrl, _toastCtrl, _http, _page, _shareData, _valid, _activeRoute, _optionset) {
    ...
    AddOnBind(type, sourid) {
        ...
        if (type == '1') {
            ...
            this._http.getForToaken(this.mod.getOnlyleadDetail, {
                "id": sourid,
            }, (res) => {
            ...
            this._http.getForToaken(this.mod.getContactcDetail, {
                "id": sourid,
            }, (res) => {
            ...
            this._http.getForToaken(this.mod.getAccountDetail, {
                "id": sourid,
            }, (res) => {
                this.showcount = true;
                if (!this._valid.isNull(res["Attributes"])) {
    ...
    EditOnBind(id) {
        ...
        this._http.getForToaken(this.mod.querydetailUrl, {
            "id": id,
        }, (res) => {
            if (!this._valid.isNull(res["Attributes"])) {
    ...
    OnPostClick() {
        ...
        this._page.loadingShow();
        this._http.postForToaken(this.mod.addoreditUrl, postData, (res) => {
            this._page.loadingHide();
            console.log(res);
            if (res.Result == true) {
                const that = this;
...
//# sourceMappingURL=saleing-mcs-cultivatetask-com-edit-edit-module-es2015.js.map