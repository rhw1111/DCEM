...
let DetailPage = class DetailPage {
    ...
    pageOnLogCalllist() {
        ...
        // debugger;
        this._page.loadingShow();
        this._http.postForToaken(this.mod.apiUrlList1, this.mod.params, (res) => {
            // debugger;
            if (res !== null) {
                if (res.Results !== null) {
    ...
    pageOnActivitylist() {
        ...
        this.mod.datalist2 = [];
        this._page.loadingShow();
        this._http.postForToaken(this.mod.apiUrlList2, this.mod.params2, (res) => {
            debugger;
            if (res !== null) {
                if (res.Results !== null) {
                    for (var key in res.Results) {
