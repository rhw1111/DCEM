...
var EditPage = /** @class */ (function () {
    function EditPage(_modalCtrl, _navCtrl, _http, _page, _logininfo, activeRoute, _optionset, _valid) {
    ...
    EditPage.prototype.ngOnInit = function () {
        ...
        this.activeRoute.queryParams.subscribe(function (params) {
            if (params['onlyleadid'] != null && params['onlyleadid'] != undefined) {
                ...
                _this.model.onlyLeadId = params['onlyleadid'];
    ...
    EditPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.model.apiUrl, {
            ...
            if (res !== null) {
                ...
                //线索来源
                _this.onlylead["mcs_leadorigin"] = String(res["Attributes"]["mcs_leadorigin"]);
                //电话
                _this.onlylead["mcs_mobilephone"] = res["Attributes"]["mcs_mobilephone"];
                //性别
                _this.onlylead["mcs_gender"] = String(res["Attributes"]["mcs_gender"]);
                //邮箱
                _this.onlylead["mcs_emailaddress1"] = res["Attributes"]["mcs_emailaddress1"];
                //评分
                _this.onlylead["mcs_accountpoints"] = String(res["Attributes"]["mcs_accountpoints"]);
                //用车省份
                ...
                _this.onlylead["mcs_provinceid"] = res["Attributes"]["_mcs_provinceid_value"];
                //城市名称
                ...
                _this.onlylead["mcs_cityid"] = res["Attributes"]["_mcs_cityid_value"];
                //区名称
                ...
                _this.onlylead["mcs_districtid"] = res["Attributes"]["_mcs_districtid_value"];
                console.log(res);
                console.log(_this.onlylead);
            }
            else {
    ...
    EditPage.prototype.saveOnClick = function () {
        ...
        this._http.postForToaken(this.model.postApiUrl, this.model.postData, function (res) {
            ...
            if (res !== null) {
                ...
                _this._page.goto("/saleing/onlylead/success", { guid: guid });
            }
            else {
                _this._page.alert("消息提示", "编辑记录失败");
            }
            _this._page.loadingHide();
        }, function (err) {
            _this._page.alert("消息提示", "编辑记录失败");
