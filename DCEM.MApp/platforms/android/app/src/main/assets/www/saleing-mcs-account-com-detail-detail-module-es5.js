...
var DetailPage = /** @class */ (function () {
    ...
    DetailPage.prototype.pageOnLogCalllist = function () {
        ...
        this.mod.LogcallModel.list = [];
        this._page.loadingShow();
        this._http.postForToaken(this.mod.LogcallModel.apiUrl, this.mod.LogcallModel.params, function (res) {
            if (res !== null) {
                if (res.Results !== null) {
                    for (var key in res.Results) {
                        ...
                        _this.mod.LogcallModel.list.push(obj);
                    }
                    //console.log(res);
                } //判断是否有新数据
                if (res.Results.length < _this.mod.LogcallModel.params.PageIndex) {
                    _this.mod.LogcallModel.isending = true;
                }
            }
            else {
    ...
    DetailPage.prototype.pageOnActivitylist = function () {
        ...
        this._page.loadingShow();
        this._http.postForToaken(this.mod.ActivityModel.apiUrl, this.mod.ActivityModel.params, function (res) {
            if (res !== null) {
                if (res.Results !== null) {
                    for (var key in res.Results) {
                        var obj = {};
                ...
                //判断是否有新数据
                if (res.Results.length < _this.mod.LogcallModel.params.PageIndex) {
                    _this.mod.ActivityModel.isending = true;
                }
            }
            else {
                _this._page.alert("消息提示", "联络记录加载异常");
