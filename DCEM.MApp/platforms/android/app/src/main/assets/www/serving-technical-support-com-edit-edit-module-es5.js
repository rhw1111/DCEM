...
var EditPage = /** @class */ (function () {
    function EditPage(_http, _page, _valid, _userInfo, modalCtrl, activeRoute, menuController) {
        this._http = _http;
        this._page = _page;
        this._valid = _valid;
    ...
    EditPage.prototype.ngOnInit = function () {
        ...
        this.activeRoute.queryParams.subscribe(function (params) {
            if (params['id'] != null && params['id'] != undefined) {
                ...
                _this.model.viewData.title = app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].PageTitleEditTech;
            }
            else {
                _this.model.viewData.title = app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].PageTitleAddTech;
            }
        });
    ...
    EditPage.prototype.GetDetail = function (id) {
        ...
        this._http.get(this.model.detailApiUrl, {
            ...
            _this._page.alert(app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].AlterTitleMessage, app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].ErrorRequestException);
            _this._page.loadingHide();
        });
    };
    //选择服务委托书模式窗口
    ...
    EditPage.prototype.save = function () {
        ...
        this._http.post(this.model.postApiUrl, this.model.postData, function (res) {
            ...
            _this._page.loadingHide();
            _this._page.alert(app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].AlterTitleMessage, app_base_base_ser_message_service__WEBPACK_IMPORTED_MODULE_11__["MessageService"].InfoSaveFailed);
        });
    };
