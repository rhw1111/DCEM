...
var DetailPage = /** @class */ (function () {
    function DetailPage(_http, _page, _valid, activeRoute) {
        this._http = _http;
        this._page = _page;
        this._valid = _valid;
    ...
    DetailPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.mod.apiUrl, {
            ...
            if (!_this._valid.isNull(res.CustomerfollowuplogList)) {
            ...
            if (!_this._valid.isNull(res.TagList)) {
