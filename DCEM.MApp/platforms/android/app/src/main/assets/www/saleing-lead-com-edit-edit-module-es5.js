...
/* harmony import */ var _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../base/base.ser/optionset.service */ "./src/app/base/base.ser/optionset.service.ts");
...
var EditPage = /** @class */ (function () {
    function EditPage(_modalCtrl, _http, _page, _valid, _userinfo, _optionset) {
    ...
    //客户标签点击事件
    EditPage.prototype.checkClick = function (event) {
    ...
    //获取客户标签
    EditPage.prototype.getcustomertag = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this._http.postForToaken(this.CustomerTagModel.apiCustomerTagUrl, { "UserId": this._userinfo.GetSystemUserId() }, function (res) {
                    ...
                    for (var i in data) {
                        ...
                        if (colorindex == _this.CustomerTagModel.CustomColor.length - 1) {
                            colorindex = 0;
                        }
                        obj["customcolor"] = _this.CustomerTagModel.CustomColor[colorindex];
                        colorindex++;
                        _this.CustomerTagModel.CustomerTags.push(obj);
                    }
                });
                return [2 /*return*/];
            });
    ...
    EditPage.prototype.saveOnClick = function () {
        ...
        this._http.postForToaken(this.model.apiUrl, this.model.info, function (res) {
            ...
            if (res !== null) {
                var guid = res["Id"];
                _this._page.goto("/saleing/lead/success", { guid: guid });
            }
            else {
                _this._page.alert("消息提示", "创建留资记录失败");
            }
    ...
    EditPage.ctorParameters = function () { return [
        ...
        { type: _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_6__["OptionSetService"] }
    ]; };
    EditPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"],
            ...
            _base_base_ser_optionset_service__WEBPACK_IMPORTED_MODULE_6__["OptionSetService"]])
    ], EditPage);
    return EditPage;
}());
...
//# sourceMappingURL=saleing-lead-com-edit-edit-module-es5.js.map