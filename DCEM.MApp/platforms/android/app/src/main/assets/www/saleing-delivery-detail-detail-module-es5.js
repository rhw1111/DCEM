        ...
        this._http.postForToaken(this.model.apiUrlDetail, { 'id': this.model.id, 'userid': this._userinfo.GetSystemUserId() }, function (res) {
            if (res !== null) {
                ...
                if (attr["mcs_submitpdi@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.issubmitpdi += attr["mcs_submitpdi@OData.Community.Display.V1.FormattedValue"]; //是否提交pdi检测
                }
                if (attr["mcs_submitpdion@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.pdisubmittime += attr["mcs_submitpdion@OData.Community.Display.V1.FormattedValue"]; //PDI检测提交时间
                }
                if (attr["mcs_pdidetecton@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.pditime += attr["mcs_pdidetecton@OData.Community.Display.V1.FormattedValue"]; //PDI检测时间
                }
                if (attr["mcs_appointmenton@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.appointmenton += attr["mcs_appointmenton@OData.Community.Display.V1.FormattedValue"]; //预约时间
                }
                if (attr["mcs_settlestatus@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.settlestatus += attr["mcs_settlestatus@OData.Community.Display.V1.FormattedValue"]; //结清状态
                }
                if (attr["mcs_receipton@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.receipton += attr["mcs_receipton@OData.Community.Display.V1.FormattedValue"];
                }
                if (attr["mcs_deliveryon@OData.Community.Display.V1.FormattedValue"] != null) {
                    _this.deliverorderflowmodel.model.deliveryon += attr["mcs_deliveryon@OData.Community.Display.V1.FormattedValue"]; //交车时间
                }
        ...
        this._http.postForToaken(this.orderpaymodel.apiUrlDetailOrderPay, this.orderpaymodel.search, function (res) {
            if (res.Results !== null) {
                ...
                if (data.length < _this.orderpaymodel.search.pagesize) {
                    ...
                    if (_this.orderpaymodel.search.pageindex != 1) {
