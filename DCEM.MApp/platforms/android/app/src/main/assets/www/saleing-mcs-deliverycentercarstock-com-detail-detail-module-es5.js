...
var DetailPage = /** @class */ (function () {
    ...
    DetailPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.mod.apiUrl, {
            ...
            if (!_this._valid.isNull(res.Deliverycentercarstock)) {
                _this.mod.data.deliverycentercarstock = res.Deliverycentercarstock["Attributes"];
            }
            if (!_this._valid.isNull(res.Vehiclematerial)) {
                _this.mod.data.vehiclematerial = res.Vehiclematerial["Attributes"];
            }
            if (!_this._valid.isNull(res.Vehicle)) {
                _this.mod.data.vehicle = res.Vehicle["Attributes"];
            }
            if (!_this._valid.isNull(res.Dealercarmovein)) {
                _this.mod.data.dealercarmovein = res.Dealercarmovein["Attributes"];
            }
...
//# sourceMappingURL=saleing-mcs-deliverycentercarstock-com-detail-detail-module-es5.js.map