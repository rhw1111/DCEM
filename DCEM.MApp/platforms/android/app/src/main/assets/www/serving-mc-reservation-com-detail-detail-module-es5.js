    ...
    DetailPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.model.apiUrlDetail, {
            ...
            if (res !== null) {
                ...
                _this.model.infolist.mcs_vin = res["Attributes"]["mcs_customerid"]["mcs_name"];
                _this.model.infolist.mcs_enginennumber = res["Attributes"]["mcs_enginennumberres"];
                _this.model.infolist.mcs_cartype = res["Attributes"]["mcs_cartype"]["mcs_name"];
                ...
                _this.model.infolist.mcs_appointmentconfigid = res["Attributes"]["mcs_appointmentconfigid"]["mcs_name"];
