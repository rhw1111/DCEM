    ...
    DetailPage.prototype.pageOnBind = function (id) {
        ...
        this._http.post(this.model.apiUrlDetail, { 'id': this.model.id, 'userid': this._userinfo.GetSystemUserId() }, function (res) {
            if (res !== null) {
                ...
                _this.model.info.amount = attr["mcs_amount@OData.Community.Display.V1.FormattedValue"];
                _this.model.info.code = attr["mcs_code"];
                _this.model.info.paycategory = attr["mcs_paycategory@OData.Community.Display.V1.FormattedValue"];
                _this.model.info.payon = attr["mcs_payon@OData.Community.Display.V1.FormattedValue"];
                _this.model.info.batchcode = attr["mcs_batchcode"];
                _this.model.info.itemname = attr["mcs_itemname"];
                _this.model.info.itemcode = attr["mcs_itemcode"];
                _this.model.info.remark = attr["mcs_remark"];
            }
            else {
...
//# sourceMappingURL=saleing-orderpaydetail-detail-detail-module-es5.js.map