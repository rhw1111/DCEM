...
var DetailPage = /** @class */ (function () {
    function DetailPage(_http, _page, activeRoute, menuController) {
        this._http = _http;
        this._page = _page;
    ...
    DetailPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.mod.apiUrl, {
            ...
            if (res.TechnicalSupport != null) {
                ...
                _this.mod.data.TechnicalSupport.mcs_orderstatus = res["TechnicalSupport"]["Attributes"]["mcs_orderstatus"];
