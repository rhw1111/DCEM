...
var ListPage = /** @class */ (function () {
    function ListPage(_http, _page, _userinfo, _optionset) {
        this._http = _http;
        this._page = _page;
        ...
        this._http.postForToaken(this.mod.apiUrl, this.mod.searchData, function (res) {
            if (res.Results !== null) {
                ...
                for (var i in data) {
                    ...
                    obj["clues"] = _this._optionset.GetOptionSetNameByValue("mcs_leadorigin", attr["mcs_leadorigin"]);
                    obj["Id"] = data[i]["Id"];
...
//# sourceMappingURL=saleing-lead-com-list-list-module-es5.js.map