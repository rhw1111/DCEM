...
var EditPage = /** @class */ (function () {
    function EditPage(_http, _page, _valid, activeRoute, _logininfo) {
        this._http = _http;
        this._page = _page;
        this._valid = _valid;
    ...
    EditPage.prototype.ngOnInit = function () {
        ...
        this.activeRoute.queryParams.subscribe(function (params) {
            _this.model.postData.systemUserId = _this._logininfo.GetSystemUserId();
            if (params['id'] != null && params['id'] != undefined) { //唯一线索主键id
                _this.model.postData.entityid = params['id'];
            }
            if (params['mcslogcallid'] != null && params['mcslogcallid'] != undefined) { //联络任务 主键id
                _this.model.postData.mcs_logcallid = params['mcslogcallid'];
                _this.pageOnBind(params['mcslogcallid']);
            }
        });
    };
    //根据主键加载联络记录(logcall)
    EditPage.prototype.pageOnBind = function (id) {
        ...
        this._http.get(this.model.detailApiUrl, {
            ...
            if (res !== null) {
                if (res.Results !== null) {
                    _this.model.postData.mcs_content = res.Results[0]["Attributes"]["mcs_content"];
                    _this.model.postData.mcs_visittime = res.Results[0]["Attributes"]["mcs_visittime"];
                    _this.model.postData.mcs_results = res.Results[0]["Attributes"]["mcs_results"];
                    _this.model.postData.entityid = res.Results[0]["Attributes"]["_mcs_onlyleadid_value"];
                }
                else {
    ...
    EditPage.prototype.saveLogcall = function () {
        var _this = this;
        var errMessage = "";
        ...
        this._http.post(this.model.postApiUrl, this.model.postData, function (res) {
            ...
            if (res.Result == true) {
                ...
                _this._page.goto("/saleing/onlylead/detail", { id: _this.model.postData.entityid });
            }
            else {
...
//# sourceMappingURL=saleing-mcs-contactrecord-edit-edit-module-es5.js.map