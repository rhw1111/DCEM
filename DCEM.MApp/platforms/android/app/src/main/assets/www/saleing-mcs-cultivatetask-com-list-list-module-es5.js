...
var ListPage = /** @class */ (function () {
    function ListPage(_http, _page, httpService, optionset, _logininfo) {
        this._http = _http;
        this._page = _page;
        ...
        this._http.get(this.model.apiUrl, {
            ...
            if (res.Results !== null) {
                ...
                res.Results.forEach(function (item) {
                    ...
                    obj["mcs_activitystatus"] = _this.optionset.GetOptionSetNameByValue("mcs_activitystatus", item["Attributes"].mcs_activitystatus);
                    obj["mcs_importantlevel"] = _this.optionset.GetOptionSetNameByValue("mcs_importantlevel", item["Attributes"].mcs_importantlevel);
                ...
                //判断是否有新数据
                _this.model.searchnodata = res.Results.length == 0;
    ...
    //任务完成
    ListPage.prototype.TaskFinish = function (id) {
        var _this = this;
        this._page.confirm("确认提示", "确定完成该任务？", function () {
            _this.UpdateState(id);
        });
    };
    ListPage.prototype.UpdateState = function (id) {
        var _this = this;
        //debugger;
        var postData = {};
        postData["id"] = id;
...
//# sourceMappingURL=saleing-mcs-cultivatetask-com-list-list-module-es5.js.map