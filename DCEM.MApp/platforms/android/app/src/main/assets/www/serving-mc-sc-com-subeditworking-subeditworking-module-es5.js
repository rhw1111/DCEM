...
var SubeditworkingPage = /** @class */ (function () {
    function SubeditworkingPage(_http, _page, _shareData, _valid, _modalCtrl, _activeRoute) {
        this._http = _http;
        this._page = _page;
    ...
    SubeditworkingPage.prototype.ionViewWillEnter = function () {
        ...
        this._activeRoute.queryParams.subscribe(function (params) {
            ...
            if (_this.mod.actionCode === 1) {
                ...
                _this.mod.data = Object.assign({}, _this.shareData.serviceorderrepairitemMap[_this.mod.mapkey]);
            }
        });
    };
    //保存
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._modalCtrl.create({
                            component: app_serving_serving_ser_components_select_repairitem_select_repairitem_component__WEBPACK_IMPORTED_MODULE_4__["SelectRepairitemComponent"]
                        })];
                    case 1:
                        modal = _a.sent();
    ...
    //选择维修类型
    SubeditworkingPage.prototype.presentRepairitemtypeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    //选择维修类别
    SubeditworkingPage.prototype.presentRepairitemtypedetailModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var errMessage, modal, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    //计算总金额
    SubeditworkingPage.prototype.caleMoney = function () {
