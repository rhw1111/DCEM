...
var ListPage = /** @class */ (function () {
    function ListPage(_modalCtrl, _http, _page, _valid, _userinfo, _optionset) {
    ...
    //搜索
    ListPage.prototype.searchOnCharge = function () {
        this.model.deliverys = [];
        this.listOnBind(null);
    };
    //搜索
    ...
    ListPage.prototype.listOnBind = function (event) {
        ...
        this._http.postForToaken(this.model.apiUrl, this.model.search, function (res) {
            if (res.Results !== null) {
...
//# sourceMappingURL=saleing-delivery-list-list-module-es5.js.map