...
var EditPage = /** @class */ (function () {
    function EditPage(_http, _page, activeRoute, _valid, _optionset) {
        this._http = _http;
        this._page = _page;
    ...
    EditPage.prototype.ngOnInit = function () {
        ...
        this.activeRoute.queryParams.subscribe(function (data) {
            if (data['id'] != null && data['id'] != undefined) {
                ...
                _this.model.info.delivery = data['id'];
                _this.model.paycategoryoption = _this._optionset.Get("mcs_paycategory");
            }
        });
    };
    EditPage.prototype.saveOnClick = function () {
        ...
        this._http.postForToaken(this.model.apiUrlDetail, this.model.info, function (res) {
            if (res !== null) {
                if (res.Result) {
                    _this._page.alert("消息提示", "新建收款记录成功", function () {
                ...
                _this._page.alert("消息提示", "新建收款记录失败");
            }
...
//# sourceMappingURL=saleing-orderpaydetail-edit-edit-module-es5.js.map