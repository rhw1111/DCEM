...
namespace MSLibrary.FileManagement.DAL
{
    ...
    public class UploadFileStore : IUploadFileStore
    {
        ...
        private async Task<string[]> GetDBAllStoreInfo(string regardingType, string regardingKey, string hashGroupName)
        {
            ...
            //获取前缀的哈希节点关键字,
            var dbInfo = await StoreInfoHelper.GetHashStoreInfo(_hashGroupRepository, _storeInfoResolveService, hashGroupName, regardingType, regardingKey);
        ...
        private string[] GetDBAllStoreInfoSync(string regardingType, string regardingKey, string hashGroupName)
        {
            ...
            //获取前缀的哈希节点关键字,
            var dbInfo = StoreInfoHelper.GetHashStoreInfoSync(_hashGroupRepository, _storeInfoResolveService, hashGroupName, regardingType, regardingKey);
        ...
        private async Task<List<string[]>> GetDBReadStoreInfos(string hashGroupName)
        {
            ...
            var storeInfos = await StoreInfoHelper.GetHashStoreInfos(_hashGroupRepository, _storeInfoResolveService, hashGroupName);
