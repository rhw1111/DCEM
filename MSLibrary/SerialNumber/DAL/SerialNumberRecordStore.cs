...
namespace MSLibrary.SerialNumber.DAL
{
    ...
    public class SerialNumberRecordStore : ISerialNumberRecordStore
    {
        ...
        public async Task Add(SerialNumberRecord record)
        {
            ...
            var storeInfo = await StoreInfoHelper.GetHashStoreInfo(_hashGroupRepository, _storeInfoResolveService, _hashGroupName, record.Prefix);
        ...
        public async Task<SerialNumberRecord> QueryByPrefix(string prefix)
        {
            ...
            var storeInfo = await StoreInfoHelper.GetHashStoreInfo(_hashGroupRepository, _storeInfoResolveService, _hashGroupName, prefix);
