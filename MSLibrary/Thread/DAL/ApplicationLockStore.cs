...
namespace MSLibrary.Thread.DAL
{
    ...
    public class ApplicationLockStore : IApplicationLockStore
    {
        ...
        {
            var storeInfo = await StoreInfoHelper.GetHashStoreInfo(_hashGroupRepository, _storeInfoResolveService, _hashGroupName, lockName);
        ...
        {
            var storeInfo = StoreInfoHelper.GetHashStoreInfoSync(_hashGroupRepository, _storeInfoResolveService, _hashGroupName, lockName);
